    ...
    sidebarLayout(
        ...
        mainPanel(
            ...
            tabsetPanel(
                ...
                tabPanel("App Explication",textOutput("para1"), textOutput("para2"), 
                         textOutput("para3_1"), textOutput("para3_2"), textOutput("para3_3"), textOutput("para3_4"),
                         , textOutput("para4"), textOutput("para5_1"), textOutput("para5_2"), textOutput("para5_3"), textOutput("para6")),
...
server <- function(input, output, session) {
    ...
    output$para3_4 <- renderText({paste0("Non-European characters such as Chinese, Korean, Japanese and Thai may cause system shutdown and will be replaced by blocks on the plot.")})
